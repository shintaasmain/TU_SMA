        ...
        <div class="row">
                <!-- DATA BUAT SAMPUL -->
                   <div class="card-body">
                    ...
                    <h4 class="col-form-label text-md-right col-12 col-md-3 col-lg-3 nama"><?=$p->nama_user?></h4>
                    <h4 class="col-form-label text-md-right col-12 col-md-3 col-lg-3 jenis"><?=$p->jenis_pegawai?></h4>
                    <h4 class="col-form-label text-md-right col-12 col-md-3 col-lg-3 jabatan"><?= $p->nama_jabatan?></h4>
                <?php endforeach;?>
                </div>
                </div>
            </div>
